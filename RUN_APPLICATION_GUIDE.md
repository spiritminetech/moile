...
✅ Backend server is ready at http://192.168.1.8:5002
```
...
- **Base URL:** http://192.168.1.8:5002
- **Environment:** Development

### Mobile App Configuration
- **Framework:** Expo/React Native
- **API Base URL:** Should point to backend (http://192.168.1.8:5002)
...
curl http://192.168.1.8:5002/api/supervisor/projects

# Get attendance monitoring
curl http://192.168.1.8:5002/api/supervisor/attendance-monitoring
```
