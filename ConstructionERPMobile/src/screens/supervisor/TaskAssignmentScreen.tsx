...
const TaskAssignmentScreen: React.FC = () => {
  ...
  const handleCreateTask = useCallback(async () => {
    try {
      ...
      const taskRequest: TaskAssignmentRequest = {
        workerId: createTaskForm.workerId,
        taskId: Date.now(), // Mock task ID - in real app, this would be generated by backend
        priority: createTaskForm.priority,
        estimatedHours: createTaskForm.estimatedHours,
        instructions: createTaskForm.instructions,
        requiredSkills: createTaskForm.requiredSkills,
        dependencies: createTaskForm.dependencies,
      };

      const response = await supervisorApiService.assignTask(taskRequest);
