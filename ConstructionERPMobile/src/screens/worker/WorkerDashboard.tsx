      ...
      <View style={styles.content}>
        ...
        <View style={styles.actionsGrid}>
          <TouchableOpacity style={styles.actionCard}>
            ...
            <Text style={styles.actionSubtitle}>View assigned work</Text>
          </TouchableOpacity>
        ...
        <View style={styles.statusCard}>
          <Text style={styles.statusTitle}>🎉 Login Successful!</Text>
          <Text style={styles.statusText}>
            Authentication is working correctly. You are now logged in as a Worker.
          </Text>
          <Text style={styles.statusNote}>
            This is a placeholder dashboard. Individual features will be implemented in subsequent tasks.
          </Text>
        </View>
      </View>
    </View>
