...
**API Base URL**: `http://192.168.1.6:5002/api`
...
app.listen(5002, '0.0.0.0', () => {
  console.log('Server running on http://192.168.1.6:5002');
});
```
...
6. **Test**: Visit `http://192.168.1.6:5002/api/health`

## Network Configuration:

Your React Native app will automatically use:
- **Android Emulator**: `http://10.0.2.2:5002/api`
- **iOS Simulator**: `http://192.168.1.6:5002/api`
- **Physical Devices**: `http://192.168.1.6:5002/api`
