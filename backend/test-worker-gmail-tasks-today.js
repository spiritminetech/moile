...
const testWorkerGmailTasksToday = async () => {
  try {
    console.log('🔍 Testing Tasks Today API for worker@gmail.com...\n');
    ...
    if (tasksData.success && tasksData.data) {
      ...
      console.log('   Details:', tasksData.details || 'No additional details');
    }
