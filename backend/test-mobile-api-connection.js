...
async function testMobileApiConnection() {
  try {
    ...
    console.log('Expected URL: http://192.168.1.8:5002/api');
    ...
    console.log('  - API_CONFIG.BASE_URL: http://192.168.1.8:5002/api');
    ...
    console.log('2. Verify mobile device can reach 192.168.1.8:5002');
