...
async function properlyAddTwoTasks() {
  try {
    ...
    console.log(`🗑️  Deleted ${deleteResult.deletedCount} existing tasks for employee 107\n`);
    ...
    console.log('✅ TWO NEW TASKS ADDED SUCCESSFULLY!');
    console.log('====================================');
    console.log('🔄 RESTART THE BACKEND NOW');
    console.log('📱 Then reload the mobile app');
