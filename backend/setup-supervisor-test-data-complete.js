...
async function setupSupervisorTestData() {
  try {
    ...
    console.log('   1. Login: POST http://192.168.1.8:5002/api/auth/login');
    console.log('   2. Get Tasks: GET http://192.168.1.8:5002/api/supervisor/active-tasks/1');
    console.log('   3. Update Targets: PUT http://192.168.1.8:5002/api/supervisor/daily-targets\n');
